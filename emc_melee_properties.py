...
import struct
import pymem
from bpy.props import (IntProperty, StringProperty, BoolProperty, PointerProperty, FloatVectorProperty)
...
def set_global_vars(dol):
    global SAVE_STATE, LOAD_STATE, SAVE_STATE_SLOT, LOAD_STATE_SLOT, \
        CURRENT_FRAME, FRAME_STEP, EMU_FRAME, SCREEN_SHOT
...
# def read_uptime():
#     current_uptime = pm.read_bytes(GALE01 + CPU_UPTIME, 1)
#    current_uptime = int.from_bytes(current_uptime, byteorder='big')
...
def img_seq(context):
    take_screenshot()
    frame_step()
    ss_uptime = pm.read_bytes(GALE01 + CPU_UPTIME, 1)
    print("Initial ss_uptime:", ss_uptime)

    while True:
        current_uptime = pm.read_bytes(GALE01 + CPU_UPTIME, 1)
        print("Current uptime:", current_uptime)
        # time.sleep(1)

        if current_uptime != ss_uptime:
            break

        # Update ss_uptime within the loop
        ss_uptime = current_uptime
...
class control_properties(PropertyGroup):
    ...
    # Type represents what byte we're writing ie: sna_fx = 00/10
    ...
    sna_player_one_solo: BoolProperty(
        name="Solo",
        description="",
        default=False,
        # update=update_sync_player
    ...
    sna_player_one_overlay: BoolProperty(
        name="Overlay",
        description="",
        default=False,
        # update=update_sync_player
    ...
    sna_player_one_itemgrab: BoolProperty(
        name="Item Grab",
        description="",
        default=False,
        # update=update_sync_player
    ...
    sna_player_two_solo: BoolProperty(
        name="Solo",
        description="",
        default=False,
        # update=update_sync_player
    ...
    sna_player_two_overlay: BoolProperty(
        name="Overlay",
        description="",
        default=False,
        # update=update_sync_player
    ...
    sna_player_two_itemgrab: BoolProperty(
        name="Item Grab",
        description="",
        default=False,
        # update=update_sync_player
    ...
    sna_player_three_solo: BoolProperty(
        name="Solo",
        description="",
        default=False,
        # update=update_sync_player
    ...
    sna_player_three_overlay: BoolProperty(
        name="Overlay",
        description="",
        default=False,
        # update=update_sync_player
    ...
    sna_player_three_itemgrab: BoolProperty(
        name="Item Grab",
        description="",
        default=False,
        # update=update_sync_player
    ...
    sna_player_four_solo: BoolProperty(
        name="Solo",
        description="",
        default=False,
        # update=update_sync_player
    ...
    sna_player_four_overlay: BoolProperty(
        name="Overlay",
        description="",
        default=False,
        # update=update_sync_player
    ...
    sna_player_four_itemgrab: BoolProperty(
        name="Item Grab",
        description="",
        default=False,
        # update=update_sync_player
    )
    # print(control_properties.sna_pause)
...
class melee_properties_panel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        mytool = context.scene.my_tool
        prop_box = layout.box()
        # prop_box.alert = False
        prop_box.enabled = True
        prop_box.active = True
        # prop_box.use_property_split = False
        # prop_box.use_property_decorate = False
        ...
        prop_column.alert = False
        prop_column.enabled = True
        prop_column.active = True
        prop_column.use_property_split = False
        prop_column.use_property_decorate = False
        ...
        toggle_row.alert = False
        toggle_row.enabled = True
        toggle_row.active = True
        ...
        stage_row.alert = False
        stage_row.enabled = True
        stage_row.active = True
        stage_row.use_property_split = False
        stage_row.use_property_decorate = False
        ...
        bg_colour_grid = prop_column.grid_flow(columns=2, row_major=False, even_columns=False, even_rows=False,
                                               align=False)
        bg_colour_grid.enabled = True
        bg_colour_grid.active = True
        bg_colour_grid.use_property_split = False
        bg_colour_grid.use_property_decorate = False
        ...
        prop_column.separator(factor=2.0)
        prop_column.label(text='Character', icon_value=173)
        player_row = prop_column.row(heading='', align=False)
        player_row.alert = False
        player_row.enabled = True
        player_row.active = True
        player_row.use_property_split = False
        player_row.use_property_decorate = False
        player_row.scale_x = 1.0
        player_row.scale_y = 1.8
        player_row.alignment = 'Expand'.upper()
        if not True: player_row.operator_context = "EXEC_DEFAULT"
        player_row.prop(mytool, 'sna_vis', icon_value=257, emboss=True, toggle=True)
        player_row.menu('player_menu', text='Collision Bubbles', icon_value=467)


class player_menu(bpy.types.Menu):
    bl_idname = "player_menu"
    bl_label = ""
    ...
    def draw(self, context):
        ...
        layout.menu('player_one_submenu', text='Player One', icon_value=0)
        layout.menu('player_two_submenu', text='Player Two', icon_value=0)
        layout.menu('player_three_submenu', text='Player Three', icon_value=0)
        layout.menu('player_four_submenu', text='Player Four', icon_value=0)


class player_one_submenu(bpy.types.Menu):
    bl_idname = "player_one_submenu"
    bl_label = "Player One"
    ...
    def draw(self, context):
        ...
        layout.operator_context = "INVOKE_DEFAULT"
        layout.prop(mytool, 'sna_player_one_solo')
        layout.prop(mytool, 'sna_player_one_overlay')
        layout.prop(mytool, 'sna_player_one_itemgrab')


class player_two_submenu(bpy.types.Menu):
    bl_idname = "player_two_submenu"
    bl_label = "Player Two"
    ...
    def draw(self, context):
        ...
        layout = self.layout.column_flow(columns=1)
        layout.operator_context = "INVOKE_DEFAULT"
        layout.prop(mytool, 'sna_player_two_solo')
        layout.prop(mytool, 'sna_player_two_overlay')
        layout.prop(mytool, 'sna_player_two_itemgrab')


class player_three_submenu(bpy.types.Menu):
    bl_idname = "player_three_submenu"
    bl_label = "Player Three"
    ...
    def draw(self, context):
        ...
        layout = self.layout.column_flow(columns=1)
        layout.operator_context = "INVOKE_DEFAULT"
        layout.prop(mytool, 'sna_player_three_solo')
        layout.prop(mytool, 'sna_player_three_overlay')
        layout.prop(mytool, 'sna_player_three_itemgrab')


class player_four_submenu(bpy.types.Menu):
    bl_idname = "player_four_submenu"
    bl_label = "Player Four"
    ...
    def draw(self, context):
        ...
        layout = self.layout.column_flow(columns=1)
        layout.operator_context = "INVOKE_DEFAULT"
        layout.prop(mytool, 'sna_player_four_solo')
        layout.prop(mytool, 'sna_player_four_overlay')
        layout.prop(mytool, 'sna_player_four_itemgrab')
...
def unregister():
    ...
    for cls in reversed(op_classes):
        unregister_class(cls)
    for cls in reversed(player_classes):
        unregister_class(cls)
